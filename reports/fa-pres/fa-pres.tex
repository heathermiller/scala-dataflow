...
\begin{frame}
  ...
  \begin{alltt} \small
    \sK{val} \sV{pa1} = ParSeq.tabulate(100)(x => x * x)\\
...
\begin{frame}
  ...
  \begin{overprint}
    ...
    \onslide<16>\includegraphics[page=15]{fa-job-map}
    \onslide<17>\includegraphics[page=16]{fa-job-map}
    \onslide<18>\includegraphics[page=17]{fa-job-map}
  \end{overprint}
