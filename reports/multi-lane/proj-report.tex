...
\begin{abstract}
  ...
  MLFPs and lies out the benchmarking results from \cite{FP12} to show
  that MLFPs may reduce insertion time by $49 - 54\%$ on a 4-core i7
  machine with respect to comparable concurrent queue data structures
...
upper lane selection strategy is efficient. For details, refer to
