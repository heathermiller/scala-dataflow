...
Note that currently, this scheme does only split in terms of the outer
blocks, i.e. individual elements of inner FlowArrays are always
assigned to the same calculation blocks. This is OK as long as the
number of inner FlowArrays is (relatively) high.
...
introduced by the \texttt{flatMap}. This is an interface issue; the
implementation is trivial. For details how block splitting is
