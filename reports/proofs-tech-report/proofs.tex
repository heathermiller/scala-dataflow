...
% \newcommand{\prooflocation}[1]{Appendix~\ref{sec:full-proofs}}
\newcommand{\prooflocation}[1]{the companion technical report~\cite{technical-appendix}}
...
\title{FlowPools: A Lock-Free Deterministic Concurrent Dataflow Abstraction -- Proofs}

% a short form should be given in case it is too long for the running head
\titlerunning{FlowPools: Lock-Free Deterministic Concurrent Dataflow -- Proofs}

\author{Aleksandar Prokopec\inst{1} \and Heather Miller\inst{1} \and Philipp Haller\inst{2} \and Tobias Schlatter\inst{1} \and Martin Odersky\inst{1}}
 
\authorrunning{FlowPools: Lock-Free Deterministic Concurrent Dataflow -- Proofs}
...
Typesafe, Inc.\\
\mailsa
\ifreport{\\ \bigskip EPFL-REPORT-181098}
}
...
this report, we present the detailed proofs of the linearizability, lock-
freedom,  and determinism properties of FlowPools, a deterministic concurrent
dataflow abstraction presented in \cite{Prokopec12}.
