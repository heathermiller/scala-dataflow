...
\title{FlowPools: Efficient Deterministic Non-Blocking Queues}

% a short form should be given in case it is too long for the running head
\titlerunning{FlowPools: Efficient Deterministic Non-Blocking Queues}
...
\authorrunning{FlowPools: Efficient Non-Blocking Queues}
...
Forcing a bib, \cite{bowman:reasoning}, \cite{braams:babel},
\cite{clark:pct}, \cite{herlihy:methodology}, \cite{Lamport:LaTeX},
\cite{salas:calculus}
