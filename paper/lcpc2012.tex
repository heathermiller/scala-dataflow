...
In the book by \cite{RoyH2004}, the Oz programming language is
described, which offers a range


Things to probably cite: Oz, gpars, i-Structures \cite{Arvind89}, our futures writeup, twitter futures, MultiLISP futures \cite{Halstead85}, FlumeJava \cite{Chambers10}.
