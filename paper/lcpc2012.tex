...
\begin{definition}[Interleaving]
  ...
  \set{\texttt{nop}}~|~P_n$. An \emph{interleaving} is a reduction of $t$
...
(a) $t$ does not terminate for any valid interleaving, or (b) $t$ always
terminates with the same result for all valid interleavings.
\end{definition}
