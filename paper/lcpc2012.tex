...
UltraSPARC T2 with 64 hardware threads. We varied the parallelism
level $P$ from $1$ to $8$ on the first architecture, and from $1$ to
$64$ on the latter two. Here, we discuss the scaling of the said
data structures (see fig~\ref{fig:eval-cpu-scaling}). For additional
evaluations, please refer to the appendix.
...
Each separate histogram is constructed by a thread (or up to $P$, for
