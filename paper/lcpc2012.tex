...
of scheduled asynchronous computations called $futures$.

A \textbf{scheduled asynchronous computation} is a pair $(f, e)$ of a function
...
\begin{proof}
Similar to proof of lemma \ref{lemma-foreach}.
\end{proof}
