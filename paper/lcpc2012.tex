...
list of values.
This is what the method \verb=toListFuture= does. 
...
We ignore commutativity and associativity
in the aggregation, hence discarding determinism.
We can still maintain determinism given that we use
a \verb=Set= datatype instead of a \verb=List=.
The method \verb=toList= starts by sealing the pool to
...
it has not been already completed.
